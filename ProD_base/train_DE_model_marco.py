...
def caculate_cont_loss(args, local_q_vector, local_ctx_vectors, local_positive_idxs):
    ...
    # print('global_q_vector:', global_q_vector.size(), 'global_ctxs_vector:', global_ctxs_vector.size(), 'positive_idx_per_question:', len(positive_idx_per_question))
    # print('positive_idx_per_question:', positive_idx_per_question)
    loss, is_correct = loss_function.calc(
        global_q_vector,
        global_ctxs_vector,
        positive_idx_per_question,
...
def main():
    ...
    # saved_state = load_states_from_checkpoint("../result/DE_12layer/marco_ckpt")
